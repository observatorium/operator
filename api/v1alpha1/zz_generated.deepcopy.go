...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LokiResourcesSpec) DeepCopyInto(out *LokiResourcesSpec) {
	*out = *in
	if in.Compactor != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LokiResourcesSpec.
func (in *LokiResourcesSpec) DeepCopy() *LokiResourcesSpec {
	if in == nil {
		return nil
	}
	out := new(LokiResourcesSpec)
	in.DeepCopyInto(out)
	return out
}
